...
public class User {
    ...
    @ManyToMany()
    @JoinTable(name = "favorite_subjects", joinColumns = @JoinColumn(name = "user_id"), inverseJoinColumns = @JoinColumn(name = "subject_id"))
    private ArrayList<Subject> favoriteSubjects;

    // Files favorite by the user
    @ManyToMany()
    @JoinTable(name = "favorite_files", joinColumns = @JoinColumn(name = "user_id"), inverseJoinColumns = @JoinColumn(name = "file_id"))
    ...
    @ManyToMany()
    @JoinTable(name = "upvoted_posts", joinColumns = @JoinColumn(name = "user_id"), inverseJoinColumns = @JoinColumn(name = "post_id"))
    private ArrayList<Post> upvotedPosts;

    // Posts downvoted by the user
    @ManyToMany()
    @JoinTable(name = "downvoted_posts", joinColumns = @JoinColumn(name = "user_id"), inverseJoinColumns = @JoinColumn(name = "post_id"))
    private ArrayList<Post> downvotedPost;

    // Comments upvoted by the user
    @ManyToMany()
    @JoinTable(name = "upvoted_comments", joinColumns = @JoinColumn(name = "user_id"), inverseJoinColumns = @JoinColumn(name = "comment_id"))
    private ArrayList<Comment> upvotedComments;

    // Comments downvoted by the user
    @ManyToMany()
    @JoinTable(name = "downvoted_comments", joinColumns = @JoinColumn(name = "user_id"), inverseJoinColumns = @JoinColumn(name = "comment_id"))
